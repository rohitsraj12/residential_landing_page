<?php 
    ...
    $project_detail = "
                        <p>
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloribus, quibusdam incidunt in asperiores iste qui voluptatem quas libero ipsum quis officiis labore ea recusandae impedit, eaque ipsa eos, magni voluptates.
                        </p>
...
<head>
    ...
    <meta property="business:contact_data:street_address" content="Electronic City Phase I">
...
<body>
    <div class="body__wrap">
        <div class="body__header">
            ...
            <header class="wrap__container">
                <div class="header__brand">
                    <a href="index.html">
                        <img src="img/logo/logo-lakefront.png" alt="">
                    </a>
                </div>
                <!-- end header brand -->
                ...
                <nav class="header__nav" id="header-nav">
                    <ul>
                        ...
                        <li class="nav__list"><a href="" class="nav__link">Floor Plans</a></li>
                        <li class="nav__list"><a href="" class="nav__link">Aminities</a></li>
                        <li class="nav__list"><a href="" class="nav__link">Specificaion</a></li>
                        <li class="nav__list"><a href="" class="nav__link">Gallery</a></li>
                        <li class="nav__list"><a href="" class="nav__link">Location</a></li>
        ...
        <div class="body__banner">
            <div class="wrap__banner">
                <div class="banner__img">
                    <img src="img/banner/banner-lg.jpg" class="banner__image-lg" alt="">
                    <img src="img/banner/banner-sm.jpg" class="banne__image-sm" alt="">
                </div>
            </div>
        </div>
        <!-- end body banner -->
        ...
        <div class="body__container">
            <main>
                <section class="section__about wrap__section">
                    <div class="container">
                        <header class="pb-4">
                            <h2 class="section__header pb-3">about <?php echo $project;?></h2>
                            <h4 class="section__header-sub w-75 m-auto">
                                Lorem, ipsum dolor sit amet natur exercitationem consectetur Lorem ipsum dolor sit amet. adipisci voluptatem libero eos rem tenetur dolore!
                            </h4>
                        </header>
                        <div class="row align-items-md-center">
                            <div class="col-md-6 order-md-2">
                                <video controls class="section__video">
                                    <source src="img/video/gopalan_florenza.mp4" type="video/mp4">
                                    Sorry, your browser doesn't support embedded videos.
                                </video>
                                <!-- <iframe width="100%" height="315" src="https://www.youtube.com/embed/3LYpGqD9-7I" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                            </div>
                            <div class="col-md-6 order-md-1">
                                <?php echo $project_detail;?>
                                <div class="pt-3">
                                    <button href="" class="btn__primary"  data-toggle="modal" data-target="#about">Know more</button>
                                </div>
                            </div>
                ...
                <section class="section__floor-plan bg-light">
                    <div class="container wrap__section">
                        <div class="row align-items-md-center">
                            <div class="col-md-4">
                                <article>
                                    <header class="section__header-secondary">
                                        Why to Live in Condio?
                                    </header>

                                    <div class="pt-4">
                                        <ul class="floor__plan-group">
                                            <li class="p-1">Living inside a nature</li>
                                            <li class="p-1">Underground parking</li>
                                            <li class="p-1">Easy access for all</li>
                                            <li class="p-1">Non-stop security</li>
                                            <li class="p-1">Spacious Apartments</li>
                                        </ul>
                                    </div>
                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                      <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <img src="img/floor_map/florenza_floor_plan_2bhk.jpg" class="w-100" alt="">
                                            </div>
                                            <div class="col-sm-6">
                                                <article>
                                                    <header class="section__header-secondary pb-3">
                                                        2bhk floor plan
                                                    </header>
                                                    <p>
                                                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ratione vel repudiandae autem non suscipit assumenda accusantium fugiat quos recusandae quam repellat iste, dolores asperiores voluptatem modi, cupiditate repellendus, rem dolor.
                                                    </p>

                                                    <footer>
                                                        <a href="" class="btn__primary">View Floor Plan</a>
                                                    </footer>
                                                </article>
                                            </div>
                                        </div>
                                      ...
                                      <div class="carousel-item">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <img src="img/floor_map/florenza_floor_plan_3bhk.jpg" class="w-100" alt="">
                                            </div>
                                            <div class="col-sm-6">
                                                
                                                <article class="section__header-secondary pb-3">
                                                    <header >
                                                        3bhk floor plan
                                                    </header>
                                                    <p>
                ...
                <section class="section__amenity wrap__section">
                    <div class="wrap__container">
                        
                        <header class="pb-4">
                            <h2 class="section__header pb-3">Amenities</h2>
                            <h4 class="section__header-sub  w-75 m-auto">
                                ...
                                <div class="owl-carousel">
                                    <div class="item">
                                            <div class="icon__block">
                                                <figure>
                                                    <svg class="amenity__svg" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    ...
                                    <div class="item">
                                        <div class="icon__block">
                                            <figure>
                                                <svg class="amenity__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><g id="outline"><path d="M42,10H22A20.023,20.023,0,0,0,2,30v4A20.023,20.023,0,0,0,22,54H42A20.023,20.023,0,0,0,62,34V30A20.023,20.023,0,0,0,42,10ZM30,16H41A15.017,15.017,0,0,1,56,31v2A15.017,15.017,0,0,1,41,48H23A15.017,15.017,0,0,1,8,33V31A15.017,15.017,0,0,1,23,16h1v2H23A13.015,13.015,0,0,0,10,31v2A13.015,13.015,0,0,0,23,46H41A13.015,13.015,0,0,0,54,33V31A13.015,13.015,0,0,0,41,18H30Zm0,4H41A11.013,11.013,0,0,1,52,31v2A11.013,11.013,0,0,1,41,44H23A11.013,11.013,0,0,1,12,33V31A11.013,11.013,0,0,1,23,20h1v2a10,10,0,0,0,0,20H40a10,10,0,0,0,0-20H30Zm-4-8h2v2H26Zm0,4h2v2H26Zm0,4h2v2H26Zm14,4a8,8,0,0,1,0,16H24a8,8,0,0,1,0-16ZM60,34A18.021,18.021,0,0,1,42,52H22A18.021,18.021,0,0,1,4,34V30A18.021,18.021,0,0,1,22,12h2v2H23A17.019,17.019,0,0,0,6,31v2A17.019,17.019,0,0,0,23,50H41A17.019,17.019,0,0,0,58,33V31A17.019,17.019,0,0,0,41,14H30V12H42A18.021,18.021,0,0,1,60,30Z"/></g></svg>
                                            </figure>
                                            <header>
                                                Jogging track
                                            </header>
                                    ...
                                    <!-- <div class="item">
                                        <div class="icon__block">
                                            <figure>
                                                <svg class="amenity__svg" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m512 167c0-8.570312-2.425781-16.914062-6.960938-24.050781l-89.746093-142.949219h-318.585938l-89.699219 142.878906c-4.585937 7.210938-7.007812 15.550782-7.007812 24.121094 0 19.554688 12.539062 36.226562 30 42.421875v302.578125h452v-302.578125c17.460938-6.195313 30-22.867187 30-42.421875zm-452 315v-270h30v186.980469h332v-186.980469h30v270zm60-143.019531h272v30h-272zm272-30h-272v-96.980469h272zm75-126.980469h-422c-8.269531 0-15-6.730469-15-15 0-2.859375.804688-5.636719 2.367188-8.097656l80.925781-128.902344h285.414062l80.96875 128.976562c1.519531 2.390626 2.324219 5.164063 2.324219 8.023438 0 8.269531-6.730469 15-15 15zm0 0"/></svg>
                                            </figure>
                                            <header>
                ...
                <section class="section__gallery">
                    <div class="container wrap__section">
                        <header class="pb-4">
                            <h2 class="section__header pb-3">Photo Gallery</h2>
                            <h4 class="section__header-sub  w-75 m-auto">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </h4>
                        </header>
                        ...
                        <div class="section__body">
                            <!-- <div class="row" id="gallery" data-toggle="modal" data-target="#exampleModal">
                                <div class="col-6 col-sm-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="0">
                                        <figure>
                                            <img class="gallery__img" src="img/gallery/bed_room.jpg" alt="">
                                        </figure>
                                ...
                                <div class="col-6 col-sm-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="1">
                                        <figure>
                                            <img class="gallery__img" src="img/gallery/bed_room.jpg" alt="">
                                        </figure>
                                        <h2 class="gallery__header">
                                ...
                                <div class="col-6 col-sm-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="2">
                                        <figure>
                                            <img class="gallery__img" src="img/gallery/bed_room.jpg" alt="">
                                        </figure>
                                        <h2 class="gallery__header">
                                ...
                                <div class="col-6 col-sm-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="3">
                                        <figure>
                                            <img class="gallery__img" src="img/gallery/bed_room.jpg" alt="">
                                        </figure>
                                        <h2 class="gallery__header">
                                ...
                                <div class="col-6 col-sm-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="4">
                                        <figure>
                                            <img class="gallery__img" src="img/gallery/bed_room.jpg" alt="">
                                        </figure>
                                        <h2 class="gallery__header">
                                ...
                                <div class="col-6 col-sm-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="5">
                                        <figure>
                                            <img class="gallery__img" src="img/gallery/bed_room.jpg" alt="">
                                        </figure>
                                        <h2 class="gallery__header">
                            ...
                            <div class="row" id="gallery" data-toggle="modal" data-target="#exampleModal">
                                <div class="col-6 col-sm-4 col-lg-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="0">
                                        <figure>
                                            <!-- <img class="gallery__img" src="img/gallery/bed_room.jpg" alt=""> -->
                                            <img class="w-100" src="img/gallery/gym.jpg" alt="First slide">
                                        </figure>
                                        <h2 class="gallery__header">
                                            gym
                                        </h2>
                                    </article>
                                    <!-- <img class="w-100" src="img/gallery/gym.jpg" alt="First slide" data-target="#carouselExample" data-slide-to="0"> -->
                                </div>
                                <div class="col-6 col-sm-4 col-lg-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="1">
                                        <figure>
                                            <!-- <img class="gallery__img" src="img/gallery/bed_room.jpg" alt=""> -->
                                            <img class="w-100" src="img/gallery/kids_area.jpg" alt="First slide">
                                        </figure>
                                        <h2 class="gallery__header">
                                            kids area
                                        </h2>
                                ...
                                <div class="col-6 col-sm-4 col-lg-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="2">
                                        <figure>
                                            <!-- <img class="gallery__img" src="img/gallery/bed_room.jpg" alt=""> -->
                                            <img class="w-100" src="img/gallery/living_room.jpg" alt="First slide">
                                        </figure>
                                        <h2 class="gallery__header">
                                            living room
                                        </h2>
                                ...
                                <div class="col-6 col-sm-4 col-lg-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="3">
                                        <figure>
                                            <!-- <img class="gallery__img" src="img/gallery/bed_room.jpg" alt=""> -->
                                            <img class="w-100" src="img/gallery/swimming_pool.jpg" alt="First slide">
                                        </figure>
                                        <h2 class="gallery__header">
                                            swimming pool
                                        </h2>
                                ...
                                <div class="col-6 col-sm-4 col-lg-4">
                                    <article class="article__gallery-block" data-target="#carouselExample" data-slide-to="4">
                                        <figure>
                                            <img class="w-100" src="img/gallery/bed_room.jpg" alt="First slide">
                                            <!-- <img class="gallery__img" src="img/gallery/bed_room.jpg" alt=""> -->
                                        </figure>
                                        <h2 class="gallery__header">
                                            bed room
                ...
                <section class="section__enquiry">
                    <div class="container wrap__section">
                        <div class="row">
                            <div class="col-md-8">
                                <h2 class="text-light">
                            ...
                            <div class="col-md-4 text-md-right">
                                <a href="#" class="btn__primary">Enquire Now</a>
                            </div>
                        </div>
                    </div>
                </section>

                <section class="section__map wrap__section">
                    <div class="container">
                        
                        
                        <header class="pb-4">
                            <h2 class="section__header pb-3">Project Location</h2>
                            <h4 class="section__header-sub w-75 m-auto">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </h4>
                        </header>
                        ...
                        <div class="section__body">
                            <div class="row">
                                <div class="col-sm-7">
                                    <iframe class="google__map" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11000.148083859367!2d77.50320421613692!3d12.898740363171017!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xc4c3c4a3dffc9d96!2sGopalan%20Florenza!5e0!3m2!1sen!2sin!4v1614668490301!5m2!1sen!2sin" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                                </div>
                                <div class="col-sm-5">
                                    <article>
                                        <header class="section__header-secondary">
                ...
                <section class="section__testimonial">
                    <div class="container wrap__section">
                      ...
                      <header class="pb-4">
                          <h2 class="section__header pb-3">Our Client Reviews</h2>
                          <h4 class="section__header-sub  w-75 m-auto">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                          </h4>
                      </header>
                                  ...
                                  <blockquote class="section__blockquote">
                                      <article class="text-center">
                                          <header class="blockquote__header">
                                            <figure>
                                                <img src="img/testimonial/testimonial_1.jpg" alt="">
                                            </figure>
                                            <h4>
                                                name
                                            </h4>
                                          ...
                                          <div class="blockquote__body">
                                              <p>
                                                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nesciunt, voluptatum quisquam aperiam minima debitis molestiae!
                                              </p>
                                          </div>
                                      </article>
                                  </blockquote>
                ...
                <section class="section__contact-us wrap__section">
                    <div class="container">
                        ...
                        <div class="section__body pt-5">
                            <div class="row align-items-md-center">
                                <div class="col-sm-7">
                                    <section>
                                        <article>
                                            <figure class="text-center pb-4">
                                                <img src="img/svg/contact_us.svg" class="contact_img" alt="">
                                            </figure>
                                            <header>
                                                <h4 class="pb-3">
                                                ...
                                                <p>
                                                    Are You Ready to Buy Dream Flat Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                                </p>
                                            </header>
                                            <footer>
                                                <a href="" class="btn__primary">9972015052</a>
                                            </footer>
                                ...
                                <div class="col-sm-5">
                                    <form class="py-4 px-5 border bg-light">
                                        
                                        <header class="section__header-secondary pb-2 pt-1 text-center border-bottom mb-3">
                                            Contact Form
                                        </header>
        ...
        <div class="body__footer py-5 text-light">
            <div class="wrap__container">
                <div class="row">
                    <div class="col-sm-3">
                        <article>
                            ...
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae ab laboriosam porro odio quo commodi illum deserunt veritatis tempora nobis.
                            </p>
                        </article>
                    </div>
                    <div class="col-sm-3">
        ...
        <div class="section__model">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div id="carouselExample" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="img/gallery/gym.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="img/gallery/kids_area.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="img/gallery/living_room.jpg" alt="Third slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="img/gallery/swimming_pool.jpg" alt="Fourth slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="img/gallery/bed_room.jpg" alt="Fourth slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="img/gallery/kitchen.jpg" alt="Fourth slide">
                        </div>
                        </div>
                    ...
                    <button type="button" class="btn__primary" data-dismiss="modal">Close</button>
                    </div>
                </div>
                </div>
            </div>
            ...
            <!-- about project form -->
            <div class="modal fade" data-backdrop="static"  id="about" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">About Lake Front</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="submit_base" class="btn__primary">Submit</button>
                    </div>
                  </div>
                </div>
            </div>
