...
if (isset($_POST['email'])) {
    ...
    */ 
    $input = array(
        ...
        'subject' => 'Lead from Google Search Ads',
        'notes' => 'I am Interested in this project.Please call me',
        'channel_id' => 'Google Search Ads',
        'rep_id' => 'gopalanadmin',
    ...
    //die;
        ...
        $subject = "Enquiry From Lake Front Landing Page | Google Search Ads";
        $message = "<h4>Lake Front Landing page, Google Search Ads</h4></br>";
