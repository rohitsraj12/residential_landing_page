...
if (isset($_POST['email'])) {
    ...
    */ 
    ...
    //die;
        ...
        $subject = "Enquiry From Lake Front Landing Page | Taboola Ads";
        $message = "<h4>Lake Front Landing page, Taboola Ads</h4></br>";
